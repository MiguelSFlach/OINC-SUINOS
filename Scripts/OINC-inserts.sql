...
INSERT INTO Granja (cnpj, nomgra, telgran, qtdanigra) VALUES
  (12345678000195, 'Granja Esperança', 11223344, 0),
  (98765432000121, 'Granja Sol Nascente', 55443322, 0),
  (55555555000199, 'Granja Boa Vista', 99887766, 0),
  (77778777789018, 'Granja União', 991887766, 0),
  (11111111000187, 'Granja Floresta Azul', 33445566, 0);
...
INSERT INTO Animal (aniid, tipani, datnas, pesani, stsani, caumor, Grupogruid, Granjacnpj) VALUES
  (1, 1, '2024-04-10', 120, 1, NULL, 1, 12345678000195),
  (2, 2, '2023-04-20', 200, 1, NULL, 2, 98765432000121),
  (3, 2, '2023-12-13', 180, 1, NULL, 2, 11111111000187),
  (4, 2, '2023-05-25', 220, 2, 'Doença respiratória', 2, 98765432000121),
  (5, 3, '2023-06-01', 80, 2, 'Acidente no curral', 3, 55555555000199),
  (6, 1, '2024-03-13', 140, 1, NULL, 1, 12345678000195),
  (7, 1, '2024-04-18', 160, 1, NULL, 1, 12345678000195),
  (8, 3, '2023-09-03', 70, 1, NULL, 3, 77778777789018),
  (9, 3, '2023-04-17', 90, 1, NULL, 3, 55555555000199),
  (10, 2, '2023-10-03', 210, 1, NULL, 2, 98765432000121),
  (11, 3, '2023-06-26', 60, 2, 'Complicações durante o parto', 3, 55555555000199),
  (12, 1, '2024-02-26', 150, 1, NULL, 1, 12345678000195),
  (13, 2, '2023-10-23', 190, 1, NULL, 2, 11111111000187),
  (14, 2, '2024-06-19', 175, 1, NULL, 2, 98765432000121),
  (15, 1, '2024-05-01', 130, 1, NULL, 1, 12345678000195),
  (16, 2, '2023-06-10', 195, 1, NULL, 2, 98765432000121),
...
UPDATE Granja AS g
SET qtdanigra = (
  SELECT COUNT(a.aniid)
  FROM Animal a
  WHERE a.Granjacnpj = g.cnpj
);
...
INSERT INTO Endereco (idend, ruaend, numend, cidend, cepend, Granjacnpj) VALUES
  ...
  (3, 'Rua Adolfo Konder', 133, 'Guaraciaba', 89920000, 55555555000199),
  (4, 'Av. Uruguai', 1700, 'Itapiranga', 89896000, 77778777789018),
  (5, 'Rua Duque de Caxias', 456, 'Maravilha', 89874000, 11111111000187);
